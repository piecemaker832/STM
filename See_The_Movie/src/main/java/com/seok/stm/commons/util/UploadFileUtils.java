package com.seok.stm.commons.util;
...
// 파일 업로드/삭제/전송,파일생성,파일명 중복방지 등의 기능을 처리할 메서드들을 가진 클래스
...
public class UploadFileUtils {
	...
	public static String uploadFile(MultipartFile file, HttpServletRequest request) throws Exception{
		...
		String originalFileName = file.getOriginalFilename(); //파일 생성
...
//		return savedFilePath.replace(File.separatorChar, '/').replace(" ", ""); //공백제거..?
