package com.seok.stm.commons.paging;
...
public class PageMaker {
	...
	private void calcData() {
		...
		// 끝페이지 번호 계산 ((현재페이지 / 페이지번호의 갯수) * 페이지 번호의 갯수) Math.ceil : 소수점 이하를 올림
    ...
    // page, perPageNum 파라미터를 포함한 URI 문자열을 만들어서(UriComponoents) 조회페이지로 이동한다 
