...
<body>
	...
	<form action="${path}/user/register" name="registerForm" id="registerForm" method="post">
		<div class="container bg-light rounded shadow-sm"
			...
			<div class="form-group">
				<span style="color: red;"><strong>*</strong></span>&nbsp; <strong>아이디</strong>
				<input type="text" id="userId" name="userId" class="form-control"
					placeholder="아이디" maxlength="20">
			</div>
			<div class="form-group">
				<span style="color: red;"><strong>*</strong></span>&nbsp; <strong>비밀번호</strong>
				<input type="password" id="userPass" name="userPass" class="form-control"
					placeholder="비밀번호" maxlength="20">
			</div>
			<div class="form-group">
				<span style="color: red;"><strong>*</strong></span>&nbsp; <strong>비밀번호
					확인</strong> <input type="password" id="userPass2" name="userPass2" class="form-control"
					placeholder="비밀번호 재확인" maxlength="20">
			</div>
			<div class="form-group">
				<span style="color: red;"><strong>*</strong></span>&nbsp; <strong>닉네임</strong>
				<input type="text" id="userName" name="userName" class="form-control"
					placeholder="닉네임" maxlength="20">
			</div>
			<div class="form-group">
				<span style="color: red;"><strong>*</strong></span>&nbsp; <strong>이메일</strong>
			...
			<div align="center">
				<button class="btn btn-primary btnJoin" id="join" type="submit">가입</button>
			</div>
		</div>
	</form>
